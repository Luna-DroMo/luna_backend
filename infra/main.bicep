...
param lunaBackendExists bool
@secure()
param lunaBackendDefinition object
...
module lunaBackend './app/luna_backend.bicep' = {
  name: 'luna_backend'
  params: {
    name: '${abbrs.appContainerApps}luna-${resourceToken}'
    location: location
    tags: tags
    identityName: '${abbrs.managedIdentityUserAssignedIdentities}luna-${resourceToken}'
    applicationInsightsName: monitoring.outputs.applicationInsightsName
    containerAppsEnvironmentName: appsEnv.outputs.name
    containerRegistryName: registry.outputs.name
    exists: lunaBackendExists
    appDefinition: lunaBackendDefinition
